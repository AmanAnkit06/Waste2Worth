...
const RecepientcardDetails = () => {
    ...
    useEffect(() => {
      const fetchRecepient = async () => {
        try {        
          ...
          console.error("Error Fetching Recepeint:", err)
        }
      }
    ...
    return (
      <div className="p-6 bg-white rounded-lg shadow">
        ...
        <p><strong>Description:</strong> {recepient.requestDescription}</p>      
        <p><strong>Donation Frequency:</strong> {recepient.recepientFrequency}</p>
